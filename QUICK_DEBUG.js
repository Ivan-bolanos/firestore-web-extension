...
(function debugFirestoreConsole() {
  ...
  if (!window.location.href.includes("/firestore/data/")) {
    console.log(
      "%c❌ Not on a Firestore document page!",
  ...
  console.log(
    "%c✅ On a Firestore document page",
  ...
  selectors.forEach((selector) => {
    try {
      ...
      if (elements.length > 0) {
        ...
        console.log(
          "  HTML preview:",
          elements[0].outerHTML.substring(0, 150) + "...",
        );
  ...
  console.log(
    "\n%c--- All Text Content (first 500 chars) ---",
    "color: orange; font-weight: bold",
  );
