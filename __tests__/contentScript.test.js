...
describe('Content Script - Data Extraction', () => {
    ...
    beforeEach(() => {
        ...
        parseDataTree = function(treeElement, targetObject) {
            ...
            const childrenContainer = treeElement.querySelector('.database-node .database-children');

            if (childrenContainer && childrenContainer.children.length > 0) {
                const childTrees = Array.from(childrenContainer.children).filter(el => el.tagName === 'F7E-DATA-TREE');
